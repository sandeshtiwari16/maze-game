 ...
 void frontscreen(void)
{
	...
	glLoadIdentity();
	glColor3f(1,1,1);
	drawstring(120,5,"Press ENTER  -->  next screen",GLUT_BITMAP_HELVETICA_18);
	drawstring(-45,5,"Maximize window for better view",GLUT_BITMAP_HELVETICA_12);
	glColor3f(1,1,1);
	output(25,160,"DON BOSCO INSTITUTE OF TECHNOLOGY");
	glColor3f(1,1,1);
	output(4.0,150,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(1,0,1);
	output(60,130,"A Mini Project On:");
	glColor3f(0,1,0.5);
	output(65,120,"\"MAZE GAME\"");
	glColor3f(1,0,1);
	output(40,100,"By:");
	glBegin(GL_LINES);
	glVertex2f(40,98);
	...
	output(40,50,"");
	glColor3f(1,0,0);
	drawstring(72,50,"(Asst. Prof.)",GLUT_BITMAP_HELVETICA_12);
	glColor3f(1,0,0);
	output(70,40,"Revathi K M, Dept. of CSE");
	glFlush();
}
 void winscreen()
 {
...
void startscreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(0.0,1.0,0.0);
	output(25,140,"WELCOME TO THE MAZE GAME OF FINDING THE PATH");
...
void instructions()
{
	...
	output(-20,100,"* FIND THE WAY TO MOVE THROUGH THE MAZE AND GET TO DESTINATION");
	...
	output(-20,40,"* YOU WILL HAVE TO HURRY AS YOU HAVE LIMITED TIME (1 minute)");
